...
//        {
//            IWorldNameable nameable = tile;
//            ITextComponent textName = tile.getDisplayName();
...
//            ItemStack itemstack1 = slot.getStack();
//
//            if (itemstack1 == null && slot.isItemValid(stack) && this.canMergeSlot(stack,
//                                                                                   slot)) // Forge: Make sure to respect isItemValid in the slot.
//            {
